...
// ...
    ...
    public function store(Request $request, $placeId)
    {
        ...
        $review->user_id =  $review->user_id + 1;

        // Assuming you have a relationship method in your Review model like 'place'
        ...
        $detail = Place::find($placeId);

        // Return the placePage view with updated reviews and details
        return view('placePage', compact('detail', 'reviews'))->with('success', 'Review created successfully');
        // return view('placePage')->with('success', 'Review created successfully');
    }
